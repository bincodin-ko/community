...
export const MOD_CATEGORIES = {
  ok: "커뮤니티 약속을 지키는 평범한 이야기, 고민, 질문, 감정 표현. 욕설이 섞인 감정 토로, 자기 자신을 향한 부정적인 말, 자신이 당한 혐오·차별의 인용과 묘사를 포함한다.",
  outing:
    "특정 개인을 식별할 수 있는 정보(실명, 학교·회사명과 결합된 특징, 전화번호, 이메일, SNS 계정, 사진 링크, 사는 동네와 직업의 조합)를 본인 동의 없이 드러냄",
  hate: "성소수자·여성·장애·인종·종교·지역 등에 대한 혐오, 모욕, 괴롭힘, 위협을 이 글의 작성자가 직접 하는 경우. 작성자가 자신이 들은 혐오 발언을 인용하거나 당한 일을 이야기하는 것은 여기에 해당하지 않는다.",
...
export async function moderateText(
  ...
  const state = {
    community_rules: [
      "한국 2030 게이 남성을 위한 익명 텍스트 커뮤니티.",
      "금지: 만남·성적 목적의 글, 타인 또는 자신의 신상 노출(연락처·계정·학교/회사와 결합된 특징), 작성자가 가하는 혐오·괴롭힘, 광고·도배.",
      "허용: 연애·성정체성·커밍아웃·가족·군대·회사 이야기, 고민과 질문, 욕설이 섞인 감정 토로, 자신이 당한 차별이나 들은 혐오 발언의 인용, 자기 자신을 향한 부정적인 말, 성 건강에 대한 정보 교환.",
      "핵심 구분: 누가 누구에게 하는 말인가. 피해를 이야기하는 것은 가해가 아니다.",
    ].join(" "),
    kind,
  ...
  const questions: Record<string, JevQuestion> = {
    ...
    crisis: {
      type: "noul",
      instructions:
        "`text`의 작성자 본인이 지금 자해·자살을 생각하거나 계획하고 있다는 신호가 있다. '죽겠다', '죽는 줄 알았다' 같은 관용 표현이나 타인·과거의 이야기만으로는 해당하지 않는다.",
    },
  };
