...
const MINDSETS: Array<[string, string, string | null]> = [
  [
    "게이라는 건 고쳐야 할 결함이 아니라, 내가 원래 정렬된 방식이다.",
    "오늘 하루 중 '나를 고쳐야 한다'고 느낀 순간이 있었나요? 그 생각은 어디서 왔을까요.",
    "Cade Bradley, Intrinsically Ordered",
  ],
  [
    "수치심은 내 안에서 자란 게 아니라, 밖에서 들어온 것이다.",
    "당신이 처음 '이건 숨겨야 해'라고 배운 장면을 기억하나요?",
    "Cade Bradley",
  ],
  [
    "욕망의 대상이 아니어도 나는 가치가 있다.",
    "앱을 지우고 싶었던 마지막 순간, 무엇이 당신을 작게 만들었나요?",
    "Cade Bradley, The Most Dangerous Mindset I See in Gay Men",
  ],
  ["커밍아웃은 사건이 아니라, 오래 걸리는 번역이다.", "당신은 지금 누구에게 어디까지 번역되어 있나요?", null],
  [
    "구조와 소속을 원하는 건 약함이 아니다. 그걸 위해 나를 지우는 게 문제일 뿐.",
    "안전하다고 느껴서 남아 있는 곳 중, 실은 나를 지우게 하는 곳이 있나요?",
    "Cade Bradley",
  ],
  ["'정상 가족'은 통계가 아니라 각본이다.", "명절에 당신이 연기하는 역할은 무엇인가요?", null],
  ["먼저 지나간 사람의 이야기는 정답이 아니라 지도다.", "지금 당신에게 필요한 건 위로인가요, 정보인가요?", null],
  [
    "나이가 드는 건 유통기한이 아니라, 내 취향이 선명해지는 것이다.",
    "'나이 들면 끝'이라는 말을 누구에게서 처음 들었나요?",
    null,
  ],
  [
    "군대에서 배운 침묵은 생존 기술이었지, 성격이 아니다.",
    "전역 후에도 여전히 켜져 있는 '침묵 스위치'가 있나요?",
    null,
  ],
  [
    "부모가 나를 이해하지 못하는 것과, 부모가 나를 사랑하지 않는 것은 다른 문장이다.",
    "두 문장을 섞어서 생각한 적이 있나요?",
    null,
  ],
  [
    "'게이답다'는 말은 규칙이 아니라 누군가의 취향이다.",
    "당신이 '게이답지 않다'고 느꼈던 순간, 그 기준은 누가 만든 건가요?",
    null,
  ],
  [
    "이중생활은 거짓이 아니라, 안전이 부족할 때의 합리적 대응이다.",
    "오늘 당신이 두 가지 버전으로 살았던 시간은 몇 시간인가요?",
    null,
  ],
  ["회사에서의 나와 여기서의 나 중, 어느 쪽이 더 피곤한가?", "그 차이는 어디서 오나요?", null],
  [
    "연애가 안 되는 것과 내가 사랑받을 수 없는 것은 인과관계가 아니다.",
    "마지막 이별에서 당신이 스스로에게 붙인 꼬리표는 무엇이었나요?",
    null,
  ],
  [
    "혐오는 논리가 아니라서, 논리로 이기려 하면 내가 먼저 지친다.",
    "오늘 굳이 이기지 않아도 되는 싸움이 있었나요?",
    null,
  ],
  [
    "긍정(affirmation)은 감상이 아니라, 실제로 삶의 결과를 바꾸는 변수다.",
    "당신을 있는 그대로 대해준 사람이 한 명이라도 있었던 해와 없었던 해, 무엇이 달랐나요?",
    "Cade Bradley",
  ],
  [
    "외로움은 내가 부족해서가 아니라, 나를 알아볼 공간이 부족해서다.",
    "당신을 '알아본' 마지막 대화는 언제였나요?",
    null,
  ],
  [
    "신앙을 버린 게 아니라, 나를 버리라는 요구를 거절한 것이다.",
    "종교가 있든 없든, 당신이 거절해야 했던 요구는 무엇이었나요?",
    "Cade Bradley",
  ],
  ["'언젠가 말해야지'의 언젠가는 날짜가 아니라 조건이다.", "그 조건은 무엇인가요? 그건 당신이 정한 건가요?", null],
  [
    "몸에 대한 평가를 내가 먼저 내면화하면, 아무도 나를 평가하지 않는 날에도 나는 평가당한다.",
    "거울 앞에서 당신이 쓰는 문장은 누구의 목소리인가요?",
    "Cade Bradley",
  ],
  [
    "나를 받아주는 사람이 아직 없다는 건, 그런 사람이 없다는 뜻이 아니다.",
    "아직 만나지 못한 사람을 위해 남겨둘 자리가 있나요?",
    null,
  ],
  [
    "위장결혼을 고민하는 건 나약함이 아니라, 압력의 크기에 대한 정직한 측정이다.",
    "그 압력의 출처를 이름 붙일 수 있나요?",
    null,
  ],
  ...
  [
    "나는 문제가 아니다. 문제는 나를 문제로 만든 것이다.",
    "오늘 이 문장을 한 번 소리 내어 읽어볼 수 있나요?",
    "Cade Bradley",
  ],
];
...
async function main() {
  ...
  console.log(
    `seeded: ${MINDSETS.length} mindsets, ${demoNames.length} demo users, ${SAMPLE_POSTS.length} sample posts`,
  );
}
